		...
		<div class="control-group text-center">
			...
			<div class="controls" align="right">
				<a href=""><button class="btn btn-success">구매</button></a> <a
					href="list?view=${param.view }&categoryId=${param.categoryId }&page=${param.page }&search=${param.search }"><button
						class="btn btn-success">글 목록</button></a> <a
					href="board?type=updateForm&articleNo=${requestScope.itemArticle.articleNo}"><button
						class="btn btn-success">글 수정</button></a> <a
					href="itemInfo?type=deleteForm&articleNo=${requestScope.itemArticle.articleNo}"><button
						class="btn btn-success">글 삭제</button></a>
			</div>
		</div>
